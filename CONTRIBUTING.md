...
1. Leggere [standard](docs/standards.md) e [architettura](docs/architecture.md).
2. Aprire una richiesta con obiettivo, ambiente, owner, criteri di accettazione e costi attesi.
...
Metix deve nominare i responsabili di piattaforma, sicurezza, finanza e approvazione dei rilasci.
